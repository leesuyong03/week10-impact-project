...
# 1. 위치-시간 그래프
# =========================================================
ax1.plot(time, y_hard,
         color='red',
         linewidth=2,
         label='맨바닥 (Hard Surface)')

ax1.plot(time, y_soft,
         color='green',
         linewidth=2,
         label='완충재 (Soft Surface)')

ax1.fill_between(time, y_hard,
                 color='red',
                 alpha=0.1)

ax1.fill_between(time, y_soft,
                 color='green',
                 alpha=0.1)

ax1.set_title('위치-시간 그래프', fontsize=15)
ax1.set_xlabel('시간 (s)', fontsize=12)
...
# 2. 가속도-시간 그래프
# =========================================================
ax2.plot(time, a_hard,
         color='red',
         linewidth=2,
         label='맨바닥 가속도')

ax2.plot(time, a_soft,
         color='green',
         linewidth=2,
         label='완충재 가속도')
...
ax2.set_title('가속도-시간 그래프', fontsize=15)
